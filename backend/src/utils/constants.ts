export const Constants = {
    API_RESPONSE_MESSAGES: {
        ...
        LIMIT_EXCEEDED_MESSAGE: 'Device limit exceeded , Only 10 peripheral devices are allowed for a gateway',
        ...
        DEVICE_ADDED_TO_GATEWAY: 'Device has been successfully added to the gateway',
